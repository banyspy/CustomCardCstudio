...
function s.initial_effect(c)
  ...
  e3:SetCondition(s.rthcon2)
  e3:SetTarget(s.rthtg2)
  e3:SetOperation(s.rthop2)
  c:RegisterEffect(e3)
end
--(1) Special Summon
